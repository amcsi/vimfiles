...
" Identifier
syn match  phpIdentifier         "$[^\x00-\x40\x5B-\x5E\x60\x7B-\x7F][^\x00-\x2F\x3A-\x40\x5B-\x5E\x60\x7B-\x7F]*"  contained contains=phpSuperglobals,phpVarSelector display
syn match  phpIdentifierSimply   "${[^\x00-\x40\x5B-\x5E\x60\x7B-\x7F][^\x00-\x2F\x3A-\x40\x5B-\x5E\x60\x7B-\x7F]*}"  contains=phpOperator,phpParent  contained display
"syn match  phpIdentifier         "$[\h<80>-\UFFFF][\w<80>-\UFFFF]*"  contained contains=phpSuperglobals,phpVarSelector display
"syn match  phpIdentifierSimply   "${[\h<80>-\UFFFF][\w<80>-\UFFFF]*}"  contains=phpOperator,phpParent  contained display
